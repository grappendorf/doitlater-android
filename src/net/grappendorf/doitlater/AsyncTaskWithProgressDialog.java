...
public abstract class AsyncTaskWithProgressDialog<Params, Progress, Result> extends AsyncTask<Params, Progress, Result>
{
	...
	private int progressMessageResource;

	AsyncTaskWithProgressDialog(Activity activity, int progressMessageResource)
	{
		this.activity = activity;
		this.progressMessageResource = progressMessageResource;
	...
	{
		progressDialog.setMessage(activity.getString(progressMessageResource));
